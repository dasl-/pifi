...
### Install
. Create a config file: https://github.com/dasl-/pifi/blob/main/sample_config.json[`config.json`]. The config file should set all of the required config parameters.
