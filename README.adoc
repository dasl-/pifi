...
. optionally create a config file: https://gist.github.com/dasl-/2081e697ab1c602a7b5dc02f100dd0a8[`config.json`]
. optional reboot to confirm services come up automatically and cleanly from a reboot: `sudo shutdown -r now`
. Check for https://github.com/dasl-/pifi/blob/master/docs/issues_weve_seen_before.adoc#cpu-throttling[CPU throttling]
