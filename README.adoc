...
1. `./install/install.sh`
    1. This may result in an https://gist.github.com/dasl-/25a6db0322f7b61ba0b3b7f3436fb975[out of memory error]. If that happens, simply re-run the install script. It should succeed the second time.
...
1. Check for https://github.com/dasl-/pifi/blob/master/docs/issues_weve_seen_before.adoc#cpu-throttling[CPU throttling]
